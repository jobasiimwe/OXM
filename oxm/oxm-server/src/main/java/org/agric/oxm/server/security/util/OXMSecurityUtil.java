...
public final class OXMSecurityUtil {
    ...
    private static Logger log = LoggerFactory
			.getLogger(OXMSecurityUtil.class);
	...
	if (user != null) {
		...
		if (StringUtils.isBlank(user.getSalt()) && StringUtils.isEmpty(user.getSalt())) {
		    user.setSalt(OXMSecurityUtil.getRandomToken());
		}

		String hashedPassword = OXMSecurityUtil.encodeString(user.getClearTextPassword()
				+ user.getSalt());
