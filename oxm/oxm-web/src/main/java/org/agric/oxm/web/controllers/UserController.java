...
public class UserController {
    ...
    @Secured({ PermissionConstants.PERM_VIEW_ADMINISTRATION, PermissionConstants.ANNONYMOUS_USER })
	...
	if (qPage.endsWith("a")) {
	    model.put(WebConstants.MODEL_ATTRIBUTE_SYSTEM_MESSAGE, "Successful Registered.");
	}
    ...
    public ModelAndView annoymousUserHander(ModelMap model) throws SessionExpiredException {
	...
	try {
	    ...
	    userService.validate(existingUser);
	    userService.saveUser(existingUser);
	    model.put(WebConstants.MODEL_ATTRIBUTE_SYSTEM_MESSAGE, "Thank You for registering. you can now login.");
