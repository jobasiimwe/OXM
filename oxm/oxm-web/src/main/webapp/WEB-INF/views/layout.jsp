...
<link type="text/css" rel="stylesheet"
	href="${baseUrl }/static/css/custom-theme/jquery-ui-1.8.15.custom.css" />
<link type="text/css" rel="stylesheet"
	href="${baseUrl }/static/css/oxm.css" />
<link type="text/css" rel="stylesheet"
	href="${baseUrl }/static/css/oxm-images.css" />
<link type="text/css" rel="stylesheet"
	href="${baseUrl }/static/css/oxm-search.css" />

<link rel="icon" type="image/png"
	href="${baseUrl }/static/images/plant-ico.png" />

<script type="text/javascript"
	src="${baseUrl }/static/js/jquery-1.7.1.min.js"></script>

<!-- 
<script type="text/javascript" src="${baseUrl }/static/js/jquery-1.6.2.min.js"></script> -->
<script type="text/javascript"
	src="${baseUrl }/static/js/jquery-ui-1.8.15.custom.min.js"></script>
<script type="text/javascript"
	src="${baseUrl }/static/js/jquery.getUrlParam.js"></script>
...
<script type="text/javascript"
	src="${baseUrl }/static/js/general-json.js"></script>
...
<body>
	...
	<p id="longResponseText" style="display: none;">${longResponseText
		}</p>
