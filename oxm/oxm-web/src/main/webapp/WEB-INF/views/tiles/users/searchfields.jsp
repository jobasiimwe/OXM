...
-->
		...
		<fieldset>
			...
			<div style="float: left;">
				<table>
					<tr>
						<td>Name/User-name <form:input cssClass="uiTextbox searchTextbox"
								path="propertiesMap['name-or-username'].value" /></td>
						...
						<td>Role <form:select id="ddRole"
								cssStyle="width:120px;" cssClass="uiDropdown searchDropdown"
								path="propertiesMap['role'].value">
								<form:option value=""></form:option>
								<form:options items="${roles }" itemLabel="name" itemValue="id" />
							</form:select></td>
						<td>Gender <form:select id="ddGender"
								cssStyle="width:60px;" cssClass="uiDropdown searchDropdown"
