...
<div id="buttonStrip">
	<div class="contextual" style="float: left;">
		...
		&emsp;&emsp;&emsp; <a id="lnkPOrgMembers" class="uiButton"
			href="${baseUrl }/porg/producers/"
		>Members</a> <a id="lnkPOrgDocs" class="uiButton"
			href="${baseUrl }/porg/docs/"
		>Documents</a> <a id="lnkPOrgStaff" class="uiButton"
			href="${baseUrl }/porg-staff/"
		>Staff</a> <a id="lnkPOrgCommittees" class="uiButton"
			href="${baseUrl }/porg-committee/"
		>Committees</a>
	</div>
			...
			<c:choose>
				...
				>
					<c:forEach var="pOrg" items="${pOrganizations }">
						<tr id="${pOrg.id }">
							<td><oxmTags:rowcheckbox nameOfItemOnPage="${nameOfItemOnPage}"
									id="${pOrg.id }"
								/>
							<td>${pOrg.name }</td>
