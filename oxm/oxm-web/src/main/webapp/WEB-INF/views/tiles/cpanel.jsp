...
<div class="cpanel">
	...
	<div class="menu">
		<a class="menu-lnk" id="lnkCountries" title="Countries"
			href="${baseUrl }/district/view/"> <span class="panellink country-icon"></span><label
			style="margin: 10px; font-size: 12px; font-weight: bold;">District</label>
		</a>
	</div>
	<div class="menu">
		<a class="menu-lnk" id="lnkCrops" title="Crops"
			href="${baseUrl }/crop/view/page/1"> <span class="panellink crop-icon"></span><label
	...
	<div class="menu">
		<a class="menu-lnk" id="lnkProductionOrg"
			...
			href="${baseUrl }/producerorg/view/"> <span
