				...
				<table>
					<tr>
						...
						<td>From <form:input id="fromdate" cssStyle="width: 100px;"
								...
								path="propertiesMap['fromdate'].value" /></td>
						<td>To <form:input id="todate" cssStyle="width: 100px;"
								cssClass="uiTextbox uiDateTextbox"
								path="propertiesMap['todate'].value" /></td>
