	...
	<form:form action="${baseUrl}/price/search" commandName="pricesearch">
		<fieldset>
			...
			<div style="float: left;">
				<table>
					<tr>
						<td>Crop <form:select id="ddCrops" cssStyle="width: 100px;"
								cssClass="uiDropdown" path="propertiesMap['cropid'].value">
								<form:option value=""></form:option>
								<form:options items="${crops }" itemLabel="name" itemValue="id" />
							</form:select>
						</td>
						<td>Place <form:select id="ddSellingPlace"
								cssStyle="width: 100px;" cssClass="uiDropdown"
								path="propertiesMap['sellingplaceid'].value">
								<form:option value=""></form:option>
								<form:options items="${sellingPlaces }" itemLabel="name"
									itemValue="id" />
							</form:select>
						</td>
						<td>Sell-Type <form:select id="ddSellType"
								cssStyle="width: 100px;" cssClass="uiDropdown"
								path="propertiesMap['selltypeid'].value">
								<form:option value=""></form:option>
								<form:options items="${selltypes }" itemLabel="name"
									itemValue="id" />
							</form:select>
						</td>
